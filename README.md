About array-api-extra-feedstock
===============================
...
pixi global install array-api-extra
```
...
It is possible to list all of the versions of `array-api-extra` available on your platform:
...
```
pixi search array-api-extra --channel conda-forge
```
